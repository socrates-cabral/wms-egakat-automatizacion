...
- Carpeta del proyecto: `C:\ClaudeWork\Productividad_Automatizacion\`
- Carpeta historica destino: `C:\Users\Socrates Cabral\OneDrive - EGA KAT LOGISTICA SPA\datos para Dashboard EK\Productividad\`
...
- Solo `WILD FOODS` y `THE NOT COMPANY` quedan inactivos por instruccion explicita.
