...
# ── Modo Paper Trading ────────────────────────────────────────────────────────
# Se lee desde config.py; si falla importación se asume paper por seguridad
try:
...
def enviar_recomendacion(partido: dict, apuesta: dict, bankroll: float) -> bool:
    ...
    mensaje = (
        ...
        f"<b>Consenso:</b> {consenso}/3 modelos\n"
        f"\n"
        ...
        f"\n"
        f"<b>Score confianza:</b> {conf_emoji} {confianza}/100\n"
